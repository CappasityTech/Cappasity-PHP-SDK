...
# Class: \CappasitySDK\Common\Validator\Rules\Uuid
...
* [public validate()](../classes/CappasitySDK.Common.Validator.Rules.Uuid.md#method_validate)
* [private getValidUuidPattern()](../classes/CappasitySDK.Common.Validator.Rules.UuidTrait.md#method_getValidUuidPattern)
---
### Details
* File: [Common/Validator/Rules/Uuid.php](../files/Common.Validator.Rules.Uuid.md)
* Package: Default
* Class Hierarchy: 
  * [\Respect\Validation\Rules\AbstractRule]()
  * \CappasitySDK\Common\Validator\Rules\Uuid
* Uses Traits:
...
**Details:**
* Inherited From: [\CappasitySDK\Common\Validator\Rules\Uuid](../classes/CappasitySDK.Common.Validator.Rules.Uuid.md)
##### Parameters:
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code></code> | $input  |  |
