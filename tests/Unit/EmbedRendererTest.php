...
EXPECTED;
     ...
     */
    public function testDeprecatedCaseSupport()
    {
        $actualEmbedCode = $this->renderer->render([
            'viewId' => '38020fdf-5e11-411c-9116-1610339d59cf',
            'width' => '100%',
